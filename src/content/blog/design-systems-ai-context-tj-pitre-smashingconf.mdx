...
excerpt: "What must a design system encode before an AI agent can use it reliably? Notes on FigmaLint, component contracts and the feedback loop that keeps design and code aligned."
