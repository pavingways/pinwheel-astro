...
One terminology correction first: Jev is not a “System 0” model. TypeSafe calls it the first **[System One Model](https://typesafe.ai/blog/introducing-system-one-models-and-jev)**. The company and documentation are at [typesafe.ai](https://typesafe.ai/), not typesafe.io. The name refers to the fast, intuitive “System 1” in Daniel Kahneman's distinction between fast and slow thinking. It is a metaphor for focused, quick judgments, not a claim that the model thinks like a person.
