...
Rarely economical in practice – switching mid-project comes close to a rebuild. That's exactly why the decision carries so much weight up front, and why we take the time for it [before the technology decision is made](/en/technologies/).

### Our team doesn't know any of these three frameworks – is that disqualifying?

No, but it shapes the recommendation: we either build with our team, or [train yours directly on the project](/en/apps-for-smes-and-startups/) – whichever makes more strategic sense. [Let's talk about it, no strings attached](/en/contact/).
