---
title: "Jev erklärt: Das System-One-Modell von TypeSafe AI für Entscheidungen statt Chat"
...
description: "Jev macht aus Text und Anwendungszustand typisierte Auswahlen, Bewertungen und Wahrscheinlichkeiten. So funktioniert das System-One-Modell von TypeSafe AI – und hier liegen seine Grenzen."
...
Jev ist das erste System-One-Modell von TypeSafe AI. Es wandelt Text oder strukturierte Anwendungszustände in klar abgegrenzte, typisierte Entscheidungen um – zum Beispiel in eine Auswahl aus vorgegebenen Optionen, numerische Bewertungen oder Ja/Nein-Wahrscheinlichkeiten. Anders als ein Chat-LLM erzeugt es weder Fliesstext noch Code, sondern ist als schnelle probabilistische Funktion innerhalb von Software gedacht. Das macht Jev interessant für Routing, Klassifizierung, Priorisierung und die Steuerung von KI-Agenten; für den produktiven Einsatz braucht es dennoch Tests mit repräsentativen Daten, geeignete Konfidenzschwellen und verlässliche Fallbacks.

## Eine andere Art von KI-Modell
...
TypeSafe bezeichnet Jev als erstes **[System One Model](https://typesafe.ai/blog/introducing-system-one-models-and-jev)**. Der Name bezieht sich auf das schnelle, intuitive «System 1» in Daniel Kahnemans Unterscheidung zwischen schnellem und langsamem Denken. Er ist eine Metapher für fokussierte, schnelle Beurteilungen – keine Behauptung, das Modell denke wie ein Mensch.
